...
def project_player(
    ...
    # NOT a literal probability: it is the fraction of the 2-point appearance
    # award we expect, and doubles as the clean-sheet eligibility factor (FPL
    # requires 60+ minutes). Exact at both ends, monotone in between.
    p_60 = float(min(1.0, minutes / MINUTES_FOR_LONG_APPEARANCE))
    ...
    appearance = APPEARANCE_MAX_POINTS * p_60
...
def project_fixture(engine, players: pd.DataFrame, home_team: str, away_team: str) -> pd.DataFrame:
